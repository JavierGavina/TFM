...
ACCELEROMETER_CHECKPOINT = f"{constants.data.train.CHECKPOINT_DATA_PATH}/Accelerometer"
MAGNETOMETER_CHECKPOINT = f"{constants.data.train.CHECKPOINT_DATA_PATH}/Magnetometer"
GYROSCOPE_CHECKPOINT = f"{constants.data.train.CHECKPOINT_DATA_PATH}/Gyroscope"
WIFI_CHECKPOINT = f"{constants.data.train.CHECKPOINT_DATA_PATH}/Wifi"
